	...
	public class StudentsController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			var merasContext = _context.Students
				...
				.AsNoTracking(); //The entities are not tracked because they're not updated in the current context.
		...
		{
			ViewData["SupervisorID"] = new SelectList(_context.Supervisors, "ID", "FullName");
		...
		public async Task<IActionResult> Create([Bind("LastName,FirstName,CreditHrs,SupervisorID,DepartmentID,AssignedInternshipID,Phone,Email")] Student student)
		{
			try
			{
			...
			ViewData["SupervisorID"] = new SelectList(_context.Supervisors, "ID", "FullName", student.SupervisorID);
